<?require_once 'e/excel/PHPExcel-1.8/Classes/PHPExcel.php';?>
<?require_once 'e/excel/PHPExcel-1.8/Classes/PHPExcel/Writer/Excel5.php';?>
<?require_once 'e/excel/PHPExcel-1.8/Classes/PHPExcel/IOFactory.php';?>
<?
ob_end_clean();
$title = 'Таблица';
...
$xls->getProperties()->setSubject("lab-5");
$xls->getProperties()->setCreator("Ахметшин Радмир");
$xls->getProperties()->setCompany("УГАТУ");
$xls->getProperties()->setCategory("ПИ-320");
$xls->getProperties()->setKeywords("bank");
$xls->getProperties()->setCreated("23.03.2020");
